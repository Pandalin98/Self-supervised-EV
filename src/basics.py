...
class GetAttr:
    ...
    def __dir__(self): 
        return self.custom_dir(self,self._dir())
    def custom_dir(self, add): return self.custom_dir(self, add)
...
def set_device(device_id):    
    ...
    device_ids = get_available_cuda(usage=5)
    torch.cuda.set_device(device_ids[device_id])   # get the first available device
