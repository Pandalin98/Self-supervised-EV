...
from layers.Blocks import Encoder, Decoder, EncoderLayer, DecoderLayer, my_Layernorm, series_decomp
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.input_dims = configs.input_dims
        ...
        self.enc_embedding = cycle_Feature_Emb(c_in=self.input_dims, d_model=self.hidden_dims)
